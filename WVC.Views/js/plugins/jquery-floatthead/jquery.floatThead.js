    ...
    $.fn.floatThead=function(map) {
        ...
        if(!util) { //may have been included after the script? lets try to grab it again.
            ...
            if(!util) {
                ...
                window.console.log("jquery.floatThead-slim.js requires underscore. You should use the non-lite version since you do not have underscore.");
            }
        }
        ...
        this.filter(':not(.'+opts.floatTableClass+')').each(function() {
            ...
            if(!$table.is('table')) {
                ...
                window.console.log('jQuery.floatThead must be run on a table element. ex: $("table").floatThead();');
                return true;
            }
            ...
            if($header.length==0) {
                ...
                window.console.log('jQuery.floatThead must be run on a table that contains a <thead> element');
                return true;
            }
    ...
    $.floatThead._=window._||(function() {
        ...
        that.keys=function(obj) {
            if(obj!==Object(obj)) {
                ...
                window.console.log('Invalid object');
                return [];
            }
            var keys=[];
