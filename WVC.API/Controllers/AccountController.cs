...
using WVC.API.Providers;
using WVC.API.Results;
using WVC.Models;
...
namespace WVC.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            District district = new District { Name = "District1" };
            ...
            {
                using (var db = new WVCContext())
                {
                    try
                    {
                        WVC.Models.User userProfile = new WVC.Models.User { UserId = registerUser.Id, FirstName = user.UserName, CreatedDate = DateTime.Now };
